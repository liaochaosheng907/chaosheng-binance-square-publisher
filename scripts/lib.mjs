...
export function resolveApiKey(args = []) {
  ...
  throw new Error(`Missing Square OpenAPI key. Set BINANCE_SQUARE_OPENAPI_KEY or save it to ${getConfigFilePath()} first.`);
}
...
export async function api(endpoint, apiKey, body, baseUrl = BASE_URL_V2) {
  ...
  try {
    ...
    console.error("API returned non-JSON response", {
      endpoint, status: res.status, statusText: res.statusText, body: raw,
    });
